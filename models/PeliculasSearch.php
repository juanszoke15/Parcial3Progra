...
class PeliculasSearch extends Peliculas
{
    ...
    public function rules()
    {
        return [
            [['id', 'year'], 'integer'],
            [['nombre_real', 'titulo', 'duracion_minutos', 'papel_realizado'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'nombre_real', $this->nombre_real])
            ...
            ->andFilterWhere(['like', 'duracion_minutos', $this->duracion_minutos])
            ->andFilterWhere(['like', 'papel_realizado', $this->papel_realizado]);
